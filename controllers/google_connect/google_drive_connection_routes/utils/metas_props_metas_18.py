...
def procesar_PROPS_metas_18(lista_json):
    kpi_documentos = []
        # Obtener los documentos más recientes de la colección
    documentos_kpi = get_latest_version_documents("KPI_METAS_SANITARIAS_18", "Metas_Sanitarias_18", False)
...
def procesar_METAS_METAS18(lista_json):
    kpi_documentos = []
        # Obtener los documentos más recientes de la colección
    documentos_kpi = get_latest_version_documents("KPI_METAS_SANITARIAS_18", "Metas_Sanitarias_18", False)
